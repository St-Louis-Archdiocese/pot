...
my $echo = 0;
my $pictures = 0;
my $picturedir = '/data/vhosts/webspeedpics.borgia.com/htdocs/skywardpictures';
my $pictureurl = 'http://webspeedpics.borgia.com/skywardpictures';
...
my $ldap = Net::LDAP->new('ldap.borgia.com', version => 3);
...
sub p {
	...
	my $initial_tab = "";
        my $subsequent_tab = "";
	print wrap($initial_tab, $subsequent_tab, @_);
}
